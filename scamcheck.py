...
class AdvancedBehavioralDetector:
    ...
    def __init__(self):
        ...
        self.red_flags = {
            ...
            'sexual_grooming': [  # NEW CATEGORY - common in modern pig-butchering escalation
        ...
        # ──── WEIGHTS (original preserved + new early + sexual) ────
        self.SCAM_PATTERN_WEIGHTS = {
            ...
            "early_grooming": 0.45,
            "sexual_grooming": 0.65   # NEW - medium-high as it's a strong escalation signal
        }
